...
const tabs = [
  { name: 'All Workshops', href: '#', current: false },
  { name: 'Beginner', href: '#', current: false },
  { name: 'Advanced', href: '#', current: false },
  { name: 'Kids & Family', href: '#', current: false },
  { name: 'Ikebana', href: '#', current: false },
...
export default function WorkshopsTabs({ activeTab, onTabChange }: TabsProps) {
